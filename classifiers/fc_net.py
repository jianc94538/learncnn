...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    rh1, cache_relu = relu_forward(h1)
    scores, cache2 = affine_forward(rh1, self.params['W2'], self.params['b2'])
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    dinput2 = relu_backward(dx2, cache_relu)
    dx1, grads['W1'], grads['b1'] = affine_backward(dinput2, cache1)
